...
export default function SixPhasePage() {
  ...
  const gradientPageH = useTransform(
    ...
    [
      "#F4F7FA",
      "#F4F7FA",
      "linear-gradient(-160deg, #1c2e8e 20%, #0050c3 55%, #050b26 100%)",
      "linear-gradient(-160deg, #1c2e8e 20%, #0050c3 55%, #050b26 100%)",
      "#F4F7FA",
    ]
  );
  ...
  const colorP = useTransform(
    ...
    ["#1c2e8e", "#1c2e8e", "rgba(160,196,255,0.7)"]
  );
  const colorTitle = useTransform(
    smooth,
    [0, isMobile ? 3.6 : 3.9, isMobile ? 3.7 : 4.0],
    ["#1c2e8e", "#1c2e8e", "#f4f7fa"]
  );
          ...
          >
            ...
            <motion.div
              style={{
                ...textWrap(
                  isMobile
                    ? { top: "25%" }
                    : { textAlign: "center", top: "20%", maxWidth: "100vw" }
                ),
                ...s0,
              }}
            >
              ...
              style={{
                ...textWrap(
                  isMobile
                    ...
                    : { top: "20%", textAlign: "center", maxWidth: "100vw" }
                ),
                ...s1,
              }}
            >
            ...
            <motion.div
              style={{
                ...textWrap(
                  isMobile
                    ? { top: "15%", textAlign: "center" }
                    : { top: "7%", textAlign: "center", maxWidth: "100vw" }
                ),
                ...s3,
              }}
            >
              ...
              >
                ...
                >
                  <div>
                    ...
                    <p
                      style={{ margin: 0, color: "rgba(200,218,250,0.60)", lineHeight: 1.2 }}
